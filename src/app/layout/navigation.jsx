    ...
    <>
      ...
      >
        <ul className={styles.mobileNavigation}>
          ...
          <li className={styles.subMobileMenu}>
            <Link href="/social-media-marketing-services" onClick={handleClick}>
              SMM
            </Link>
            <div className={styles.subMenuIcon}>
              <SubMenuIcon />
      ...
      >
        ...
        <li className={isActiveLink("/about-us") ? styles.active : ""}>
          <Link href="/about-us">About Us</Link>
        </li>
        <li className={isActiveLink("/blogs") ? styles.active : ""}>
          <Link href="/blogs">Blogs</Link>
        </li>
        <li className={isActiveLink("/contact-us") ? styles.active : ""}>
