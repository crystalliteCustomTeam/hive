...
export const TableContetData = {
    ...
    tabledata: {
        feature: [
            ...
            "Landing Page Review & CRO Suggestions",
            "Video Ads",
            "A/B Testing",
        ...
        good: [
            "$1,500 – $3,999/month",
            "Facebook & Instagram",
            "Initial Campaign Strategy Call",
            "3 Static Ad Variations (Client Assets)",
            ...
            "—",
            "Add-On Available",
            "Creative Variants Only",
            "—",
            "Email Only"
        ],
        better: [
            "$4,000 – $7,999/month",
            "FB, IG + 1 Add’l (e.g., TikTok or LinkedIn)",
            "Strategic Planning + Benchmarking",
            "4 Static + 1 Video Ad",
            "Lookalikes & Behavior Filters",
            "Multi-Step Funnel Tracking",
            "Expert Copywriting (2 Sets/Month)",
            "3x Weekly + Budget Reallocation",
            "Dedicated Strategist",
            "Bi-Weekly ROI Report",
            "Included",
        ...
        best: [
            "$8,000 – $14,999/month",
            "All Major Platforms (FB, IG, TikTok, LinkedIn, Pinterest)",
            "Funnel Mapping + A/B Blueprint",
            "6+ Custom Creatives Monthly",
            "First-Party Data & Custom Segments",
            "Advanced Attribution (GA4, CRM Sync)",
            "High-Converting Copy + Iterative Testing",
            "Daily Optimization + AI Rules",
            "Senior Strategist + Creative Director",
            "Weekly KPI Dashboard + Strategy Call",
            "Included + Dynamic Product Retargeting",
            "Monthly Insights + Heatmap Review",
            "2 Premium Videos Monthly",
            "Full-Funnel Split Testing",
            "Included",
            "On-Demand Calls"
        ]
    },
