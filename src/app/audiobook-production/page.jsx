...
import {
  ...
  CallActionData,
  FAQsData,
} from "@/src/app/audiobook-production/data/data";
          ...
          __html: JSON.stringify([
            {
              ...
              description:
                "Infiniti Digital offers a complete audiobook recording & production service. We edit, and publish your audiobook across multiple platforms. Earn upto 75% royalties.",
              brand: {
                "@type": "Brand",
