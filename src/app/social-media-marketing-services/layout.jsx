...
export const metadata = {
  ...
  //===== Canonical =====
  alternates: { canonical: '/social-media-marketing-services' },
  //===== GEO Tags =====
  other: {
    // First Region (Houston, TX) - Social Media Marketing
    "DC.title.houston": "social media marketing services",
    ...
    // Second Region (Generic US Location) - Social Media Marketing
    "DC.title.generic": "social media marketing services",
