...
const HeaderSimpleLp = () => {
    ...
    useEffect(() => {
        setIsLight(pathname === '/landing/seo1' || pathname === '/landing/seo2' || pathname === '/landing/smm1' || pathname === '/landing/gmb' || pathname === '/landing/smm3');
    }, [pathname]);
    // Chat Code
    const openChat = () => {
        if (window.LC_API) {
                ...
                <Row className="h-100">
                    ...
                    <Col xs={6} md={6} className="my-auto">
                        <div className={styles.btnFlex}>
                            <a href="tel:123-123123" className={`commonBtn`} aria-label="Visit our Contact">
                                <PhoneIcon /> +1 312 379 5987
                            </a>
