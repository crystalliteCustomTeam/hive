      ...
      <Container className="h-100">
        <Row className="h-100">
          ...
          <Col xs={6} md={8} lg={8} xl={8} xxl={7} className="my-auto">
            ...
            <ul
              className={`${styles.menuSection} ${
                ...
                scrolled ? styles.active : ""
              }`}
            >
              <li>
                <Link href="#AboutId" onClick={handleClick}>
                  About Us
                </Link>
              </li>
              <li>
                <Link href="#ProcessId" onClick={handleClick}>
                  Process
                </Link>
              </li>
              <li>
                <Link href="#ServicesId" onClick={handleClick}>
                  Services
                </Link>
              </li>
              <li>
                <Link href="#PortfolioId" onClick={handleClick}>
                  Portfolio
                </Link>
              </li>
              <li>
                <Link href="#PricingId" onClick={handleClick}>
                  Pricing
                </Link>
              </li>
              <li>
                <Link href="#TestimonialsId" onClick={handleClick}>
                  Testimonials
                </Link>
              </li>
              <li>
                <Link href="#ContactId" onClick={handleClick}>
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <Col
            ...
            xl={2}
            xxl={2}
            className="my-auto d-md-block d-none"
          >
            <a
