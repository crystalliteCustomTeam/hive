...
export const ServicesData = {
  ...
  ServicesItem: [
    ...
    },
    {
      title: (
        <>
          <Link href="/gmb-management-service" className="colorBlack">Google My <br />Business</Link></>
      ),
...
export const ContentData = {
  ...
  contentTxt: (
    <>
      ...
      <p>
        {" "}
        Whether it’s on Google Maps or local search results, your business will
        stand out. Let’s boost your local presence today!
      </p>
    </>
  ),
  img: ContentImg.src,
...
export const ContentData1 = {
  ...
  contentTxt: (
    <>
      <p>
        Get noticed by local customers with Infiniti Digital’s Local SEO
        strategies.We optimize your business to rank higher, driving foot
        traffic and enhancing online visibility.
      </p>
      <p>
        From keyword research to local map listings, we ensure your business is
        easy to find.Our goal is to convert local searches into long-term, loyal
        customers.Let’s grow together!
      </p>
    </>
  ),
  img: ContentImg1.src,
  ...
  ProcessItem1: [
    {
      ...
      txt: (
        <>
          ...
          <p>
            Engage with reviews professionally—Infiniti Digital helps you
            respond, improving your reputation!
          </p>
        </>
      ),
    },
    {
      ...
      txt: (
        <>
          ...
          <p>
            We focus on hyper-targeted, long-tail keywords to capture specific
            local searchers’ intent.
          </p>
          <strong>Focus on Community Terms:</strong>
          <p>
            We incorporate community-specific terms to make sure you show up
  ...
  ProcessItem2: [
    {
      ...
      txt: (
        <>
          ...
          <p>
            Infiniti Digital keeps your Name, Address, and Phone number
            consistent across local directories.
          </p>
          <strong>Claim Local Listings:</strong>
          <p>
            We claim and optimize your business on high-quality local platforms
            like Yelp.
          </p>
    ...
    },
    {
      ...
      txt: (
        <>
          ...
          <p>
            Infiniti Digital builds local backlinks by featuring your business
            on trusted, community blogs.
          </p>
          <strong>Leverage Partnerships:</strong>
          <p>
            We create strategic partnerships with other local brands to boost
  ...
  ProcessItem3: [
    {
      ...
      txt: (
        <>
          ...
          <p>
            Infiniti Digital ensures your website is mobile-friendly, making it
            easy for local customers to browse.
          </p>
          <strong>Improve Page Load Speed:</strong>
          <p>
            We optimize your site’s speed so that it loads faster, reducing
            bounce rates.
          </p>
