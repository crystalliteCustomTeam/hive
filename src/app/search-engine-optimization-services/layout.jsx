...
export const metadata = {
  ...
  description:
    "Search engine optimization that drive tons of leads and organic revenue. Our modern SEO strategies are designed to improve online visibility & grab organic leads.F",
