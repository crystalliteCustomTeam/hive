...
const SocailLinks = [
    { icon: <Instagram />, url: "https://www.instagram.com/InfinitiDigitalus/" },
    { icon: <Facebook />, url: "https://www.facebook.com/infinitidigitalus/" },
    { icon: <Twitter />, url: "https://x.com/Infinitidigitl" },
    { icon: <Linkedin />, url: "https://www.linkedin.com/company/infiniti-digitalus" },
    { icon: <Youtube />, url: "https://www.youtube.com/@InfinitiDigitalus" },
];

export default function ThanksPageClient() {
    const searchParams = useSearchParams();
    const isPdf = searchParams.get("pdf"); // "true" or null
